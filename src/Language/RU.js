export function AddPackets(addPackFunction)
{
    ...
    {
        'conditionTitle' : 'Условия использования приложения Modulo:',
        'conditionBody' : 'Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох, Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох, Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох Лорэм ипсум доларем трах тибидох тибидох Лорэм ипсум доларем трах тибидох тибидох Лорэм ипсум доларем трах тибидох тибидох.Лорэм ипсум доларем трах тибидох тибидох. Ура товарищи, вы прочитали это!. Не ну серьёзно, кто же ставит точку после восклицательного знака? Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох, Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох, Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох. Лорэм ипсум доларем трах тибидох тибидох Лорэм ипсум доларем трах тибидох тибидох Лорэм ипсум доларем трах тибидох тибидох Лорэм ипсум доларем трах тибидох тибидох.Лорэм ипсум доларем трах тибидох тибидох. Ура товарищи, вы прочитали это!. Не ну серьёзно, кто же ставит точку после восклицательного знака?',
